        ...
        <div className='flex-centered register-form-main'>
          <div className='flex-centered register-form-column'>
            ...
            <InputBox
              ...
              validationMsg="Wprowadź poprawny numer"
            />
          </div>
          <div className='flex-centered register-form-column'>
            <InputBox
              ...
              validationMsg="Wprowadź poprawny adres"
            />
            <InputBox
              label='Hasło'
              name='password'
              ...
              validationMsg="Hasło powinno składać się z co najmniej 8 znaków, zawierać małe i duże litery oraz cyfry"
            />
            <InputBox
              label='Powtórz hasło'
              name='re-password'
              ...
              validator={isValidRepassword}
              validationMsg="Hasła powinny się gadzać"
            />
          </div>
        </div>
